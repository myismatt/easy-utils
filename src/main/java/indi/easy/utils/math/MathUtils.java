...
public final class MathUtils {
     ...
     */
    public static String format(Object o, int newScale, int roundingMode) {
    ...
    public static String format(Object o, int newScale) {
        ...
        return format(o, newScale, BigDecimal.ROUND_HALF_UP);
    }
            ...
            for (String value : transferToPostfix) {
                switch (value) {
                    case "+":
                        a = stack.pop();
                        b = stack.pop();
                        stack.push(MathUtils.sum(b, a));
                        break;
                    case "-":
                        a = stack.pop();
                        b = stack.pop();
                        stack.push(MathUtils.subtract(b, a));
                        break;
                    case "*":
                        a = stack.pop();
                        b = stack.pop();
                        stack.push(MathUtils.multiply(b, a));
                        break;
                    case "/":
                        a = stack.pop();
                        b = stack.pop();
                        stack.push(MathUtils.divide(b, a));
                        break;
