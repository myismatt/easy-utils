package indi.easy.utils.enums;

/**
 * <p>枚举功能拓展接口</p>
 * <p>实现此接口即可使用 {@link indi.easy.utils.enums.EnumUtils EnumUtils} 中的方法</p>
 * <p>样例枚举请查看 {@link indi.easy.utils.enums.DemoEnum DemoEnum}</p>
 *
 * @author 小徐
